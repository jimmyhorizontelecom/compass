...
$(document).ready(function () {
    ...
    recordlist();
    alert('Testing');
    bindDataToDdl("HardwareDropdown", "HMainCategory_ddl", "myModal", "ddlAgencyName", "Agency");
    bindDataToDdl("HardwareDropdown", "HMainCategory_ddl", "myModal", "ddlDeptName", "Department");
    bindDataToDdl("HardwareDropdown", "HMainCategory_ddl", "myModal", "ddlBillingAddress", "Billing Address");
...
async function recordlist() {
    ...
    try {
        ...
        let records = await getRecords('Manpower', 'GetRecord', filterData, '#myTable', 'N');
