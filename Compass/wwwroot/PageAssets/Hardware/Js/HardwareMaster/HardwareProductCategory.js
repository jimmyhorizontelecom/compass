...
async function recordlist() {
    ...
    try {
        ...
        let records = await getRecords('HardwareMaster', 'GetProductCatg', filterata, '#myTable', 'N');
        //alert(records);
...
//    // Prepare data
//    var isValid = fileSizeValidation('fileAttached', 2);
//    if (!isValid)
//    {
//        MsgBox('Message', "File Size should be <= 2MB", '');
//        return;
//    }
...
//        // get new file name
//        let newFileName = getNewFileName(value, "Product")
...
//        let res = await acceptUpdate("Master1", "AddOrEditRecord", formData);
